...
function getBlogs(blogArticlesArray) {
  let delay = 0;
  return blogArticlesArray.map((article, index) => {
    delay += 100;
    return (
...
function getTechnologies(article) {
  return article.map((technology, index) => {
