  ...
  constructor() {
    ...
    this.state = {
      ...
      projects: [
        {
          id: 1,
          image: '/images/patient-appointment-booking-thumbnail.jpg',
          alt: 'Patient Appointment Booking',
          name: 'Patient Appointment Booking',
          technologies: ['Next.js', 'TypeScript', 'Tailwind CSS'],
          description: 'A patient management app enabling patients to register, book, and manage appointments with doctors, with SMS.',
          github: 'https://github.com/ryan-griego/patient_appointment_booking',
          live: 'https://patient-appointment-booking.ryangriego.com/'
        },
        {
          id: 2,
          image: '/images/job-getter-thumbnail.jpg',
          alt: 'Job Getter',
          name: 'Job Getter',
          technologies: ['Nuxt.js', 'MongoDB', 'TypeScript'],
          description: 'Job Getter is a job application tracking tool designed to streamline the job search process. Users can store information about jobs they have applied to and email technical recruiters with more information.',
          github: 'https://github.com/ryan-griego/job-getter/',
          live: 'https://job-getter.ryangriego.com/'
        },
        {
          id: 3,
